...
with source(channels=required_channels) as stream:
    while True:
        ...
        for index, channel_number in enumerate(channel_numbers):
            ...
            channel_background_trigger_cell = message.data.data['SARFE10-CVME-PHO6211:Lnk9Ch%d-BG-DRS_TC' % channel_number].value
            ...
            channel_background = calibration_data.calibrate(channel_background, channel_background_trigger_cell, channel_number)

            caput('SARFE10-CVME-PHO6211:Lnk9Ch%d-DATA-CALIBRATED' % channel_number, channel_data)
            caput('SARFE10-CVME-PHO6211:Lnk9Ch%d-BG-DATA-CALIBRATED' % channel_number, channel_background)
            ...
            caput('SARFE10-CVME-PHO6211:Lnk9Ch%d-DATA-SUM' % channel_number, channel_data)
